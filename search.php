...
<header>
    ...
    <h1>AutoAvenue</h1>
    <a href="customerView.php" class="customer-view">Customer View</a>
</header>
...
<a href="addListing.php" class="add-listing-button">Add New Listing</a>
...
<div class='car-grid'>
    ...
    echo "<img src='images/{$row['Image']}' alt='Car Image' class='car-image'>";
        ...
        echo "<input type='hidden' name='car_id' value='{$row['CarID']}'>";
        echo "<button type='submit' class='remove-listing-button'>Remove Listing</button>";
        echo "</form>";
